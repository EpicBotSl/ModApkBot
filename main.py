...
@epicbot.on_message(filters.command('channel') & filters.user(ADMINS))
...
@epicbot.on_message(filters.command('logger') & filters.user(ADMINS))
...
@epicbot.on_message(filters.command('delete') & filters.user(ADMINS))
